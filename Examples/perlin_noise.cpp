...
int main()
{
    ...
    std::vector<Color> gray_scale = {GRAY_12, BLACK};
    std::vector<Color> color_scale = {DARK_RED, RED, ORANGE, YELLOW, GREEN, BLUE, MAGENTA, WHITE};
    while (1)
    {
        ...
        if (mode == MODE_1D)
        {
            ...
            for (int i = 0; i < width; i++)
            {
                ...
                r.draw_line({i, y}, {i, 40}, 'C', DARK_OLIVE);
            }
        }
